...
{
    public class ProductDetailsApiControllerTests : IClassFixture<ApiTestServerFixture>, IDisposable
    {
        ...
        public ProductDetailsApiControllerTests(ApiTestServerFixture apiTestServerFixture, ITestOutputHelper output)
        {
